...
const ComponentPreview = forwardRef<HTMLIFrameElement, ComponentPreviewProps>(
  function ComponentPreview({ component, props }, ref) {
    ...
    }, [props, iframeLoaded, ref]);

    const iframe = ref && "current" in ref ? ref.current : internalRef.current;
